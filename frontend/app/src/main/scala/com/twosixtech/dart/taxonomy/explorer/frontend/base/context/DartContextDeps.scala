...
trait DartContextDeps {
    ...
    trait DartContextBuilder {
        ...
        def ContextBuilder( renderer : (DartRouter.DartRoute, DartContext) => VdomElement ) : Unmounted[ (DartRouter.DartRoute, DartContext) => VdomElement, _, _ ]

        lazy val AppComponent : ReactComponent[ DartProps[ DartRouter.DartRoute, Unit ] => VdomElement, Unit ] =
